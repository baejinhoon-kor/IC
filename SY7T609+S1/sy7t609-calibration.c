...
EmberEventControl calibration_event_control;
...
static void start(void)
{
	uint32_t vrms_target = (uint32_t)emberUnsignedCommandArgument(0);
	uint32_t irms_target = (uint32_t)emberUnsignedCommandArgument(1);
...
EmberCommandEntry calibration[] = {
	emberCommandEntryAction("info", printInfo, "", "print Calibration Config Value"),
    emberCommandEntryAction("start", start, "ww", "start calibration"),
	emberCommandEntryAction("stop", stop, "", "stop calibration"),
